# Paços para tranformar o codigo em uma interface grafica
# 1 Importar o tk
# 2 Jogar o codigo dentro de uma função
# 3 Criar a janela usando o tk
...
janela = Tk()
janela.title('Cotação Atual das Moédas')
